...
<section id="q2" class="container col-10">
    ...
    <form action="q4.php" method="post">
        ...
        <p class="align-input">
            <input id="extraverti" type="radio" name="q3" value="extraverti">Extraverti<br>
            <label for="extraverti"></label>
        </p>

        <p class="align-input">
            <input id="malicieux" type="radio" name="q3" value="malicieux">Malicieux<br>
